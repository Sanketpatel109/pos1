        ...
        <div className="flex-1 overflow-y-auto p-4 bg-secondary flex justify-center no-scrollbar">
          ...
          >
            ...
            <div className="text-center pt-2 space-y-1.5">
              <div className="py-1.5 px-2 flex flex-col items-center justify-center border-y border-dashed border-border bg-white rounded-md">
                <Barcode128
                  value={order?.orderNumberFormatted ? `ORD-${order.orderNumberFormatted}` : `ORD-${activeOrderNum}`}
                  width={1.4}
                  height={36}
                  displayValue={true}
                  fontSize={10}

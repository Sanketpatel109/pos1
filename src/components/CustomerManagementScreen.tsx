              ...
              <div className="bg-white border border-[#d4d4d8] rounded-2xl p-4 shadow-2xs flex justify-between items-start">
                <div className="space-y-1">
                  ...
                  {activeCustomer.email && (
                    <p className="text-xs text-[#77767b]">{activeCustomer.email}</p>
                  )}
                ...
                <div className="flex gap-2">
                  ...
                  {activeCustomer.creditBalance > 0 && (
                    <button
                      onClick={() => {
                        setSettleAmount(String(activeCustomer.creditBalance));
                        setIsSettleModalOpen(true);
                      }}
                      className="px-3.5 py-2 bg-[#18181b] hover:bg-black text-white rounded-xl text-xs font-bold flex items-center gap-1.5 cursor-pointer shadow-xs active:scale-95"
                    >
